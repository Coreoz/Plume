...
import com.coreoz.plume.db.pagination.QueryDslPaginable;
...
public class TransactionManager {
	...
	public TransactionManager(DataSourceContainer dataSourceContainer) {
	...
	public <T> Paginable<T> queryDslPaginate(Function<HibernateQueryFactory, HibernateQuery<T>> toExecuteOnDb) {
		return new QueryDslPaginable<>(this, toExecuteOnDb);
	}
